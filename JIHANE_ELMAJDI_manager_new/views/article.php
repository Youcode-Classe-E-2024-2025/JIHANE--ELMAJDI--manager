...
<body>
    ...
    <main class="container">
        <div class="container mt-5 text-center">
            <h1 class="display-4 wow-title mb-4">Article</h1>
        ...
        ?>
            <div class="container mt-5">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card wow-card shadow-lg" style="border-radius: 25px; background: linear-gradient(145deg, #f5f5dc, #e1e0c6);">
                            <div class="card-body text-dark">
                                <h3 class="card-title text-center wow-title"><?= $row["title"] ?></h3>
                                <p class="card-text text-center wow-description"><?= $row["description"] ?></p>
                                <div class="mt-4">
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-auto">
                        <form action="controllers/delete_article.php?id=<?= $row['id'] ?>" method="POST">
